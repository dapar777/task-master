...
- 🏷 **Stavy úkolu**: *Ke zpracování*, *Probíhá*, *Čeká* (na vnější věc), *Blokováno*, *Hotovo* – barevně odlišené. Stav lze nastavit i **z kontextového menu** (podnabídka *Stav*), z menu *Úkol → Stav* nebo z **příkazové palety** – tedy i v **Bez rušení**, kde není vidět combobox v detailu. Působí na celý vícenásobný výběr; stavům lze v *Nastavení zkratek* přiřadit vlastní klávesu.
