...
- 🏷 **Stavy úkolu**: *Ke zpracování*, *Probíhá*, *Čeká* (na vnější věc), *Blokováno*, *Hotovo* – barevně odlišené. Stav lze nastavit i **z kontextového menu** (podnabídka *Stav*) ve stromu i v **Bez rušení**, kde není vidět combobox v detailu; působí na celý vícenásobný výběr.
