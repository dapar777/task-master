...
COMMAND_DEFS: dict[str, tuple[str, str, str, str]] = {
    ...
    "app.settings": ("Nastavení…", "Nastavení", "Ctrl+,", "window"),
    "app.shortcuts": ("Klávesové zkratky…", "Nastavení", "", "window"),
    "app.command_palette": ("Příkazová paleta…", "Aplikace", "Ctrl+Shift+P", "window"),
    "app.stats": ("Statistiky…", "Aplikace", "F8", "window"),
    "mail.import": ("Načíst úkoly z e-mailu", "Aplikace", "Ctrl+Shift+M", "window"),
    "mail.settings": ("Nastavení e-mailu…", "Nastavení", "", "window"),
    # Filtry
